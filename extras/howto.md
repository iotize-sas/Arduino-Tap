...
Once the Tap library is installed, you must include it in your project (e.g. add #include "tap.h" at the top of your .ino file).
...
If the library is correctly included in your project, the Arduino file should compile without problem after adding call: myTap.Init().
